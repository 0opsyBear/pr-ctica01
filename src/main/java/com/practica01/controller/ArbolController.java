...
public class ArbolController {
    ...
    public String mostrarPaginaInicio(Model model) {
        List<Arbol> arboles = arbolService.getArboles(); // Obtener la lista de árboles desde tu servicio
    ...
    public String arbolGuardar(Arbol arbol, @RequestParam("imagenFile") MultipartFile imagenFile){
        if(!imagenFile.isEmpty()){
            ...
            arbol.setRutaImagen(firebaseStorageService.cargarImagen(imagenFile, "arbol", arbol.getIdArbol()));
        }
        arbolService.save(arbol);
